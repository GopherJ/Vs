...
L.Handler.PathTransform = L.Handler.extend({
    ...
    _createRotationHandlers: function() {
        ...
        var handlerPositionTopPoint = map.layerPointToLatLng(
        ...
        var handlerPositionBottomPoint = map.layerPointToLatLng(
            L.PathTransform.pointOnLine(
                map.latLngToLayerPoint(topPoint),
                map.latLngToLayerPoint(bottom),
                this.options.handleLength)
        ...
        var handlerPositionLeftPoint = map.layerPointToLatLng(
            L.PathTransform.pointOnLine(
        ...
        var handlerPositionRightPoint = map.layerPointToLatLng(
            L.PathTransform.pointOnLine(
                map.latLngToLayerPoint(left),
                map.latLngToLayerPoint(right),
                this.options.handleLength)
